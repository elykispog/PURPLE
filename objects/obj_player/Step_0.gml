...
if (!global.cutscene_active) {
    ...
    if ((_horizontal_input != 0 && _vertical_input != 0) && place_meeting(x, y, obj_invisiblewall)) {
        var l = point_distance(0, 0, _horizontal_input, _vertical_input);
        _hsp = (_horizontal_input / l) * _spd;
